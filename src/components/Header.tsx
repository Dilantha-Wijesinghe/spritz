  ...
  return (
    <header style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12, marginBottom: 20 }}>
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        <Button variant="icon" title="Export backup (JSON)" aria-label="Export backup" onClick={onExport}>
        ...
        <Button variant="icon" title="Import backup (JSON)" aria-label="Import backup" onClick={() => { const el = document.getElementById('spritz-import') as HTMLInputElement | null; if (el) { el.value = ''; el.click(); } }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.75" strokeLinecap="round" strokeLinejoin="round">
            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
